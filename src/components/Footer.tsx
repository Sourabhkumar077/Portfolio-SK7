...
export default function Footer() {
  return (
    <footer className=" inter-regular border-t">
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="font-bold text-md mb-4 bbh-sans-bartle-regular red-white-text">Sourabh kumar</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-md mb-4 bbh-sans-bartle-regular red-white-text">Quick Links</h3>
          ...
          {/* Social Links */}
          <div>
            <h3 className="font-bold text-md mb-4 bbh-sans-bartle-regular red-white-text">Connect</h3>
